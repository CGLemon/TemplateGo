...
TimeControl::TimeControl(float main_time, float byo_yomi_time, int byo_yomi_stones) {
	adjust_time(main_time, byo_yomi_time, byo_yomi_stones);
	reset_clock();
}

void TimeControl::adjust_time(float main_time, float byo_yomi_time, int byo_yomi_stones) {
