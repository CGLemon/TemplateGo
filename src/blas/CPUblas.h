...
template <bool TA, bool TB> class Gemm {
public:
  static void blas_gemm(int M, int N, int K, float ALPHA, const float *A,
...
public:
  ...
  static void dense(const int inputs, const int outputs,
